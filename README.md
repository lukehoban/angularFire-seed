...
[![Open firebase/angularFire in the Visual Studio Online Editor ](http://tryvsoeditor.azurewebsites.net/Content/editwithvso.png)](http://tryvsoeditor.azurewebsites.net/Home/Hack?repo=https://github.com/lukehoban/angularFire-seed.git&name=angularFire-seed&defaultFile=readme.md)
